...
def get_top_pairs(limit=100):
    ...
    # drop BTC to avoid duplicate since we add manually
...
class Handler(http.server.BaseHTTPRequestHandler):
    ...
    def do_HEAD(self):
        self.do_GET() if self.command=='HEAD' else self.send_error(405)
